            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="<?php echo empty($_SESSION["username"]) ? "login" : "logout" ?>.php">
                                <span class="glyphicon <?php echo empty($_SESSION["username"]) ? "glyphicon glyphicon-log-in" : "glyphicon glyphicon-log-out
